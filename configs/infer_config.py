...
parser.add_argument("--dir_save_ckpt", type=str, default="./ckpts/rot/cifar10", help="dir for saving checkpoints")
parser.add_argument("--dir_save_log", type=str, default="./ckpts/rot/cifar10", help="dir for saving log file")
